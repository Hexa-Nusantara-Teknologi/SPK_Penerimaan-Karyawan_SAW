            ...
            <form action="{{ route('subkriteria.update', $subkriteria->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="criteria" name="criteria_id" required>
                        ...
                        <option value="{{ $item->id }}" {{ $subkriteria->criteria_id == $item->id ? 'selected' : '' }}>
                            {{ $item->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="fullName" name="name" value="{{$subkriteria->name}}"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="min_score" name="min_score"
                        value="{{$subkriteria->min_score}}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="max_score" name="max_score"
                        value="{{$subkriteria->max_score}}" required>
                </div>
